...
/**
 * Routes a prompt to Hanna's general-purpose default model (Gemini 3.5 Flash).
 * Respects Gemini 3.5 Flash as the default general-purpose intelligence for all business,
