...
describe("routeHannaRequest", () => {
  it("routes document and visual work to Gemini 3.5 Flash", () => {
  ...
  it("routes coding and software orchestration work to Gemini 3.5 Flash", () => {
  ...
  it("routes Shopify and store work to Gemini 3.5 Flash", () => {
  ...
  it("routes research and strategy work to Gemini 3.5 Flash", () => {
  ...
  it("keeps general prompts on Gemini 3.5 Flash", () => {
