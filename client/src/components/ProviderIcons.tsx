...
export function GoogleIcon({ size = 20, className = "" }: IconProps) {
  return (
    ...
    >
      ...
      <path
        fill="#34A853"
        d="M12 21.55c2.63 0 4.84-.87 6.45-2.35l-3.14-2.45c-.87.58-1.98.92-3.31.92-2.54 0-4.69-1.72-5.46-4.03H3.3v2.53A9.74 9.74 0 0 0 12 21.55Z"
      />
      <path
        fill="#FBBC05"
        d="M6.54 13.64A5.85 5.85 0 0 1 6.24 12c0-.57.1-1.12.3-1.64V7.83H3.3A9.75 9.75 0 0 0 2.25 12c0 1.57.38 3.05 1.05 4.17l3.24-2.53Z"
      />
      <path
        fill="#EA4335"
        d="M12 6.33c1.43 0 2.71.49 3.72 1.45l2.79-2.79C16.84 3.42 14.63 2.45 12 2.45a9.74 9.74 0 0 0-8.7 5.38l3.24 2.53c.77-2.31 2.92-4.03 5.46-4.03Z"
      />
    </svg>
  );
}
...
export function AnthropicIcon({ size = 20, className = "" }: IconProps) {
  return (
    ...
    >
      <path
        fill="#D4A574"
        d="M16.12 3H19.5L12 21h-3.38L16.12 3ZM4.5 21h3.38l2.25-5.4h5.62l.68 1.62H8.62L12 7.8l3.38 8.1H18.9L12.75 3h-1.5L4.5 21Z"
      />
    </svg>
  );
}
...
export function ShopifyIcon({ size = 20, className = "" }: IconProps) {
  return (
    ...
    >
      <path
        fill="#95BF47"
        d="M18.8 6.5s-.8-.2-1.2.2c-.4.4-.8 1.3-.8 1.3s-1.1-.3-1.8 0c-.7.3-1.2 1.1-1.2 1.1s-.6-.2-.9.1c-.3.3-.4.8-.4.8s-4.3 1.1-5.1 4.3c-.8 3.2 1.1 8 1.1 8s4.8.7 8.3-1.8c3.5-2.5 4.3-7.5 4.3-7.5s.4-4-.4-5.2c-.8-1.2-1.9-1.3-1.9-1.3Z"
      />
      <path
        fill="#5E8E3E"
        d="m15 7.8-1.3 2.4.9 3.9s.8-.3 1.4-.7c.6-.4 1.1-1 1.1-1l-2.1-4.6Z"
      />
    </svg>
  );
}
...
export function SlackIcon({ size = 20, className = "" }: IconProps) {
  return (
    ...
    >
      <path
        fill="#E01E5A"
        d="M6 15a2.5 2.5 0 1 1-2.5-2.5H6V15Zm1.25 0a2.5 2.5 0 1 1 5 0v-2.5h-5V15Z"
      />
      <path
        fill="#36C5F0"
        d="M9 6a2.5 2.5 0 1 1 2.5-2.5V6H9Zm0 1.25a2.5 2.5 0 1 1 0 5h2.5v-5H9Z"
      />
      <path
        fill="#2EB67D"
        d="M18 9a2.5 2.5 0 1 1 2.5 2.5H18V9Zm-1.25 0a2.5 2.5 0 1 1-5 0v2.5h5V9Z"
      />
      <path
        fill="#ECB22E"
        d="M15 18a2.5 2.5 0 1 1-2.5 2.5V18H15Zm0-1.25a2.5 2.5 0 1 1 0-5h-2.5v5H15Z"
      />
    </svg>
  );
}
...
export function GmailIcon({ size = 20, className = "" }: IconProps) {
  return (
    ...
    >
      <path
        fill="#4285F4"
        d="M20 18h-2V9.5L12 14 6 9.5V18H4V6h1.5l6.5 4.8L18.5 6H20v12Z"
      />
...
export function TikTokIcon({ size = 20, className = "" }: IconProps) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M16.6 5.82A4.28 4.28 0 0 1 14.54 2h-3.13v14.04a2.91 2.91 0 1 1-2.91-2.9 2.87 2.87 0 0 1 1.26.29V10.2A6.04 6.04 0 1 0 14.54 16V9.12A7.44 7.44 0 0 0 19 10.42V7.27a4.34 4.34 0 0 1-2.4-1.45Z"
      />
    </svg>
  );
}
...
export function GoogleAdsIcon({ size = 20, className = "" }: IconProps) {
  return (
    ...
    >
      <path
        fill="#FBC02D"
        d="M3.6 17.6 10 3.8a2.5 2.5 0 0 1 4.5 2.3L8.1 19.9a2.5 2.5 0 0 1-4.5-2.3Z"
      />
      <path
        fill="#4285F4"
        d="m20.4 17.6-6.4-13.8a2.5 2.5 0 0 0-4.5 2.3l6.4 13.8a2.5 2.5 0 0 0 4.5-2.3Z"
      />
...
export function YouTubeIcon({ size = 20, className = "" }: IconProps) {
  return (
    ...
    >
      <path
        fill="#FF0000"
        d="M23.5 6.2a3 3 0 0 0-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 0 0 .5 6.2 31.4 31.4 0 0 0 0 12c0 1.9.2 3.9.5 5.8a3 3 0 0 0 2.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 0 0 2.1-2.1c.3-1.9.5-3.9.5-5.8 0-1.9-.2-3.9-.5-5.8z"
      />
