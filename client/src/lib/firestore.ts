...
export type ClientMessage = { id: string; role: "user" | "assistant"; content: string; time?: string; tokenCount?: number };
export type ClientConversation = { id: string; title: string; period: string; messages: ClientMessage[]; createdAt?: string; updatedAt?: string };
export type ClientProfile = { displayName: string; photoURL: string; bio: string; jobTitle: string };
